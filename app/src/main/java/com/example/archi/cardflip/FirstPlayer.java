...
public class FirstPlayer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_first_player, container, false);
    }
    @Override
    ...
    private void findViews(View view) {
        mCardBackLayout = view.findViewById(R.id.card_back2);
        mCardFrontLayout = view.findViewById(R.id.card_front2);
